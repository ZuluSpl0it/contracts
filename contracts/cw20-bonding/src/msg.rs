...
pub enum ExecuteMsg {
    ...
    UpdateBuySell { can_buy: String, can_sell: String, devs_acct: String, burn_acct: String, 
                    raffle_acct: String, social_acct: String, expense_acct: String, },
